        ...
        value: function buscarUsuario() {
          ...
          if (this.username != "") {
            this.user.getUsuario(this.username).subscribe(function (res) {
              var u = res['user'];
              _this.nombre = u['Nombres'];
              _this.apellidos = u['Apellidos'];
              _this.correo = u['Correo'];
              _this.password = u['Password'];
              _this.genero = u['Genero'];
              _this.fechanac = u['Fecha_Nacimiento'].substring(0, 10);
              console.log(u);
            });
          }
        }
      ...
      _createClass(LoginComponent, [{
        ...
        value: function logearse() {
          ...
          this.service.login(this.datos).subscribe(function (res) {
            _this3.respuesta = res;
            console.log(_this3.respuesta);
            _this3.token = _this3.respuesta.token;

            if (_this3.respuesta.token != "") {
              _this3.decoded = Object(jwt_decode__WEBPACK_IMPORTED_MODULE_1__["default"])(_this3.respuesta.token); // console.log(this.decoded);
      ...
      _createClass(ModificarUsuarioComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (this.username != "") {
            this.user.getUsuario(this.username).subscribe(function (res) {
              var u = res['user'];
              _this4.nombre = u['Nombres'];
              _this4.apellidos = u['Apellidos'];
              _this4.correo = u['Correo'];
              _this4.password = u['Password'];
              _this4.genero = u['Genero'];
              _this4.fechanac = u['Fecha_Nacimiento'].substring(0, 10);
              console.log(u);
            });
          }
        }
